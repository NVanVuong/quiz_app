...
const StartScreen = ({ onNext }) => {
  return (
    <div className="flex flex-col justify-center items-center h-full w-max-2xl">
      ...
      <button
        onClick={onNext}
        className="px-6 py-1.5 text-lg rounded-full ring-2 ring-gray-950 font-bold text-white mt-12 bg-[#087F5B] hover:bg-[#0ca678] hover:ring-4 hover:ring-[#087F5B] transition duration-300 hover:border-0"
      >
        Start Quiz!
      </button>
    </div>
